...
MovesGen3:
	...
	move EFFECT_BURN_HIT,			90, FIRE, 		SPECIAL,	100, 20,  20 ;HEAT WAVE (MAY REQUIRE DIFFERENT EFFECT) 
	...
	move EFFECT_FOCUS_PUNCH,	   150, FIGHTING,	PHYSICAL,	100, 15,   0 ;FOCUS PUNCH
	move EFFECT_SP_ATK_UP,			 0, ELECTRIC,	STATUS,		100, 30,   0 ;CHARGE
	move EFFECT_DISABLE,			 0, DARK,		STATUS,		100, 15,   0 ;TAUNT (MIGHT NEED A DIFFERENT EFFECT)
	move EFFECT_TRICK,				 0, PSYCHIC_TYPE,	STATUS,		100, 15,   0 ;TRICK
	...
	move EFFECT_DEFENSE_DOWN_HIT,	95, GRASS,		PHYSICAL,	100, 15,  10 ;NEEDLE ARM
	...
	move EFFECT_SELF_SP_ATK_DOWN,  140, PSYCHIC_TYPE,	PHYSICAL,	100, 5,	0 ;PSYCHO BOOST
.IndirectEnd::
