...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move EFFECT_MULTI_HIT,          20, FAIRY,		PHYSICAL,    85, 15,   0 ;COMET_PUNCH
	move EFFECT_NORMAL_HIT,         80, NORMAL,		PHYSICAL,   100, 20,   0 ;MEGA_PUNCH
	...
	move EFFECT_TRAP_TARGET,        90, STEEL,		PHYSICAL,   100, 15,   0 ;VICEGRIP
	move EFFECT_OHKO,                0, NORMAL,		PHYSICAL,    30,  5,   0 ;GUILLOTINE
	move EFFECT_RAZOR_WIND,        130, FLYING,		SPECIAL,    100, 10,   0 ;RAZOR_WIND
	move EFFECT_ATTACK_UP_2,         0, NORMAL,   	STATUS,		100, 30,   0 ;SWORDS_DANCE
	move EFFECT_NORMAL_HIT,         80, BUG,      	PHYSICAL,	100, 30,   0 ;CUT
	...
	move EFFECT_TRAP_TARGET,        50, NORMAL,    	PHYSICAL,	 95, 20,   0 ;BIND
	move EFFECT_NORMAL_HIT,         80, NORMAL,   	PHYSICAL,	100, 20,   0 ;SLAM
	move EFFECT_NORMAL_HIT,         35, GRASS,    	PHYSICAL, 	100, 10,   0 ;VINE_WHIP
	move EFFECT_STOMP,              65, NORMAL,   	PHYSICAL, 	100, 20,  30 ;STOMP
	move EFFECT_DOUBLE_HIT,         45, FIGHTING, 	PHYSICAL, 	100, 30,   0 ;DOUBLE_KICK
	...
	move EFFECT_DEFENSE_DOWN_HIT,   65, BUG,     	PHYSICAL,	100, 25,  20 ;HORN_ATTACK
	...
	move EFFECT_TRAP_TARGET,        60, POISON,    	PHYSICAL, 	 85, 20,   0 ;WRAP
	move EFFECT_RECOIL_HIT,         90, NORMAL,    	PHYSICAL, 	 85, 20,   0 ;TAKE_DOWN
	move EFFECT_RAMPAGE,           120, NORMAL,   	PHYSICAL, 	100, 20,   0 ;THRASH
	...
	move EFFECT_POISON_MULTI_HIT,   50, BUG,      	PHYSICAL,	100, 20,  20 ;TWINEEDLE
	move EFFECT_MULTI_HIT,          18, BUG,       	PHYSICAL, 	 85, 20,   0 ;PIN_MISSILE
	...
	move EFFECT_RECOIL_HIT,        120, FIGHTING, 	PHYSICAL, 	100, 25,   0 ;SUBMISSION
	...
	move EFFECT_LEECH_HIT,          60, GRASS,    	SPECIAL,	100, 10,   0 ;MEGA_DRAIN
	...
	move EFFECT_RAMPAGE,           120, GRASS,    	PHYSICAL,	100, 20,   0 ;PETAL_DANCE
	...
	move EFFECT_PARALYZE,            0, ELECTRIC, 	SPECIAL,	100, 20,   0 ;THUNDER_WAVE
	...
	move EFFECT_BURN_HIT,          100, NORMAL,   	SPECIAL,	 90, 10,   0 ;EGG_BOMB
	...
	move EFFECT_TRAP_TARGET,        75, WATER,    	PHYSICAL,	 75, 10,   0 ;CLAMP
	move EFFECT_ALWAYS_HIT,         60, NORMAL,   	SPECIAL,	100, 20,   0 ;SWIFT
	move EFFECT_RECOIL_HIT,        100, ROCK,     	PHYSICAL,	100, 15,   0 ;SKULL_BASH
	...
	move EFFECT_ACCURACY_DOWN,       0, PSYCHIC_TYPE,  	STATUS,		100, 15,   0 ;KINESIS
	move EFFECT_HEAL,                0, NORMAL,   	STATUS,		100, 10,   0 ;SOFTBOILED
	move EFFECT_JUMP_KICK,         130, FIGHTING, 	PHYSICAL,	 85, 20,   0 ;HI_JUMP_KICK
	...
	move EFFECT_MULTI_HIT,          20, FIRE,     	SPECIAL,	 85, 20,   0 ;BARRAGE
	move EFFECT_LEECH_HIT,          80, BUG,      	PHYSICAL,	100, 15,   0 ;LEECH_LIFE
	move EFFECT_SLEEP,               0, FAIRY,   	STATUS,		 75, 10,   0 ;LOVELY_KISS
	move EFFECT_RECOIL_HIT,        120, FLYING,   	PHYSICAL,	100,  5,   0 ;SKY_ATTACK
	...
	move EFFECT_DEFENSE_DOWN_HIT,   90, WATER,    	PHYSICAL,	100, 10,  50 ;CRABHAMMER
...
MovesGen2:
	...
	move EFFECT_CONFUSE_HIT,       100, FLYING,   	SPECIAL,	 95,  5,  30 ;AEROBLAST
	...
	move EFFECT_ACCURACY_DOWN_HIT,  60, GROUND,   	SPECIAL,	100, 10, 100 ;MUD_SLAP
	move EFFECT_ACCURACY_DOWN_HIT, 100, WATER,    	SPECIAL,	100, 10,  50 ;OCTAZOOKA
	...
	move EFFECT_PERISH_SONG,         0, GHOST,   	STATUS,		100,  5,   0 ;PERISH_SONG
	move EFFECT_SPEED_DOWN_HIT,     55, ICE,       	SPECIAL,	 95, 15, 100 ;ICY_WIND
	move EFFECT_PROTECT,             0, FIGHTING, 	SPECIAL,	100,  5,   0 ;DETECT
	move EFFECT_MULTI_HIT,          25, GROUND,   	PHYSICAL,	 80, 10,   0 ;BONE_RUSH
	move EFFECT_LOCK_ON,             0, NORMAL,   	STATUS,		100,  5,   0 ;LOCK_ON
	move EFFECT_RAMPAGE,           130, DRAGON,   	PHYSICAL,	100, 15,   0 ;OUTRAGE
	move EFFECT_SANDSTORM,           0, ROCK,    	STATUS,		100, 10,   0 ;SANDSTORM
	move EFFECT_LEECH_HIT,         100, GRASS,    	SPECIAL,	100,  5,   0 ;GIGA_DRAIN
	...
	move EFFECT_FALSE_SWIPE,       120, NORMAL,   	PHYSICAL,	100, 40,   0 ;FALSE_SWIPE
	...
	move EFFECT_ATTACK_UP_HIT,      60, BUG,      	PHYSICAL,	100, 20, 100 ;FURY_CUTTER
	move EFFECT_DEFENSE_UP_HIT,     70, STEEL,    	PHYSICAL,	 90, 25,  10 ;STEEL_WING
	move EFFECT_MEAN_LOOK,           0, DARK,   	STATUS,		100,  5,   0 ;MEAN_LOOK
	...
	move EFFECT_PRESENT,             1, ICE,    	SPECIAL,	 90, 15,   0 ;PRESENT
	...
	move EFFECT_ATTACK_UP_HIT,      50, STEEL,    	PHYSICAL,	 95, 35,  30 ;METAL_CLAW
	...
	move EFFECT_NORMAL_HIT,        100, FIGHTING, 	PHYSICAL,	 90,  5,   0 ;CROSS_CHOP
	move EFFECT_TWISTER,            85, DRAGON,   	SPECIAL,	100, 20,  20 ;TWISTER
	...
	move EFFECT_EXTRA_PRIORITY_HIT, 80, NORMAL,   	PHYSICAL,	100,  5,   0 ;EXTREMESPEED
...
SECTION "Gen 3 Moves", ROMX

MovesGen3:
	move EFFECT_FAKE_OUT, 			40, NORMAL,		PHYSICAL,	100, 15, 100 ;FAKE OUT
	move EFFECT_RAMPAGE, 		   120, NORMAL, 	SPECIAL,	100, 15,   0 ;UPROAR
	move EFFECT_BURN_HIT,			90, FIRE, 		SPECIAL,	100, 20,  20 ;HEAT_WAVE (MAY REQUIRE DIFFERENT EFFECT) 
	move EFFECT_SPLASH,				 0, NORMAL,		STATUS, 	  0,  1,   0 ;CANNOT_MOVE
	move EFFECT_HAIL, 				 0, ICE, 		STATUS,		100, 10,   0 ;HAIL
	move EFFECT_BURN,				 0, FIRE,		STATUS,		100, 15,   0 ;WILL_O_WISP
	move EFFECT_ATTACK_DOWN_2,		 0, DARK,		STATUS,		100, 10,   0 ;MEMENTO (TODO)
	move EFFECT_FACADE,				70, NORMAL,		PHYSICAL,	100, 20,   0 ;FACADE
	move EFFECT_NORMAL_HIT,		   150, FIGHTING,	PHYSICAL,	100, 15,   0 ;FOCUS PUNCH (TODO)
	move EFFECT_SP_ATK_UP,			 0, ELECTRIC,	STATUS,		100, 30,   0 ;CHARGE
	move EFFECT_DISABLE,			 0, DARK,		STATUS,		100, 15,   0 ;TAUNT (TODO)
	move EFFECT_SPLASH,				 0, PSYCHIC_TYPE,	STATUS,		100, 15,   0 ;TRICK (TODO)
	move EFFECT_HEAL,				 0, FAIRY,		STATUS,		100, 10,   0 ;WISH
	move EFFECT_SPLASH,				 0, GRASS,		STATUS,		100, 10,   0 ;INGRAIN (TODO)
	move EFFECT_NORMAL_HIT,		   120, FIGHTING,	PHYSICAL,	100,  5,   0 ;SUPERPOWER (TODO)
	move EFFECT_SPLASH,				 0, PSYCHIC_TYPE,	STATUS,		100, 10,   0 ;MAGIC COAT (TODO)
	move EFFECT_NORMAL_HIT,		    60, FIGHTING,	PHYSICAL,	100, 20,   0 ;REVENGE (TODO)
	move EFFECT_CLEAR_STAT_HIT,		75, FIGHTING,	PHYSICAL,	100, 15,   0 ;BRICK BREAK
	move EFFECT_SLEEP,			     0, NORMAL,		STATUS,		 90,  5,   0 ;YAWN
	move EFFECT_NORMAL_HIT,			20, DARK,		PHYSICAL,	100, 15,   0 ;KNOCK OFF (TODO)
	move EFFECT_ENDEAVOR,			 1, NORMAL,		PHYSICAL,	100, 15,   0 ;ENDEAVOR
	move EFFECT_ERUPTION,		   150, FIRE,		SPECIAL,	100,  5,   0 ;ERUPTION
	move EFFECT_SPLASH,				 0, NORMAL,		STATUS,		100, 25,   0 ;REFRESH (TODO)
	move EFFECT_PRIORITY_HIT,		40, WATER,		SPECIAL,	100, 15,   0 ;DIVE
	move EFFECT_MULTI_HIT,			20, FIGHTING,	PHYSICAL,	 90, 15,   0 ;ARM THRUST
	move EFFECT_SP_ATK_UP_2,		 0, BUG,		STATUS,		100,  5,   0 ;TAIL GLOW (TODO)
	move EFFECT_SP_ATK_DOWN_HIT,	90, PSYCHIC_TYPE,	SPECIAL,	100, 15,  10 ;LUSTER PURGE
	move EFFECT_ACCURACY_DOWN_HIT,  80, ICE,		SPECIAL,	100, 15,  10 ;MIST BALL
	move EFFECT_DEFENSE_UP_2,		 0, FLYING,		STATUS,		100, 15,   0 ;FEATHERDANCE
	move EFFECT_BURN_HIT,			85, FIRE,		PHYSICAL,	100, 20,  10 ;BLAZE KICK
	move EFFECT_ROLLOUT,			30, ICE,		PHYSICAL,	 95, 30,   0 ;ICE BALL
	move EFFECT_NORMAL_HIT,			95, GRASS,		PHYSICAL,	100, 15,   0 ;NEEDLE ARM
	move EFFECT_HEAL,				 0, NORMAL,		STATUS,		100, 10,   0 ;SLACK OFF
	move EFFECT_NORMAL_HIT,			90, NORMAL,		SPECIAL,	100, 15,   0 ;HYPER VOICE
	move EFFECT_POISON_HIT,			90, POISON,		PHYSICAL,	100, 15,  10 ;POISON FANG
	move EFFECT_NORMAL_HIT,		   100, STEEL,		PHYSICAL,	100,  5,   0 ;CRUSH CLAW
	move EFFECT_HYPER_BEAM,		   150, FIRE,		SPECIAL,	 90,  5,   0 ;BLAST BURN
	move EFFECT_HYPER_BEAM,		   150, WATER,		SPECIAL,	 90,  5,   0 ;HYDRO CANNON
	move EFFECT_ATTACK_UP_HIT,		80, STEEL,		PHYSICAL,	100, 15,  10 ;METEOR MASH
	move EFFECT_FLINCH_HIT,			30,	GHOST,		PHYSICAL,	100, 30,  50 ;ASTONISH
	move EFFECT_WEATHER_BALL,		50, NORMAL,		SPECIAL,	100, 30,   0 ;WEATHER BALL
	move EFFECT_HEAL_BELL,			 0, GRASS,		STATUS,		100, 10,   0 ;AROMATHERAPY
	move EFFECT_ATTACK_DOWN,		 0, DARK,		STATUS,		100, 25,   0 ;FAKE TEARS
	move EFFECT_SPEED_UP_HIT,		65, FLYING,		SPECIAL,	100, 15,  30 ;AIR CUTTER
	move EFFECT_SELF_SP_ATK_DOWN,  130,	FIRE,		SPECIAL,	100,  5, 100 ;OVERHEAT
	move EFFECT_FORESIGHT,			 0, NORMAL,		STATUS,		100, 35,   0 ;ODOR SLEUTH
	move EFFECT_SPEED_DOWN_HIT,		60, ROCK,		PHYSICAL,	100, 25, 100 ;ROCK TOMB
	move EFFECT_ALL_UP_HIT,			60, BUG,		SPECIAL,	100, 15,  10 ;SILVER WIND
	move EFFECT_SP_DEF_DOWN,		 0, STEEL,		STATUS,		100, 15,   0 ;METAL SOUND
	move EFFECT_SLEEP,				 0, GRASS,		STATUS,		 55, 15,   0 ;GRASS WHISTLE
	move EFFECT_ATTACK_DOWN,		 0, NORMAL,		STATUS,		100, 25,   0 ;TICKLE
	move EFFECT_COSMIC_POWER,		 0, PSYCHIC_TYPE,	STATUS,		100, 15,   0 ;COSMIC POWER
	move EFFECT_ERUPTION,		   150, WATER,		SPECIAL,	100,  5,   0 ;WATER SPOUT
	move EFFECT_SP_ATK_DOWN_HIT,	75, BUG,		SPECIAL,	100, 15,  30 ;SIGNAL BEAM
	move EFFECT_ALWAYS_HIT,			60, GHOST,		PHYSICAL,	100, 20,   0 ;SHADOW PUNCH
	move EFFECT_FLINCH_HIT,			80, PSYCHIC_TYPE, 	SPECIAL,	100, 15,	0 ;EXTRASENSORY
	move EFFECT_ALWAYS_HIT,			65, FLYING,		PHYSICAL,	100, 20,   0 ;SKY UPPERCUT
	move EFFECT_TRAP_TARGET,		50, GROUND,		PHYSICAL,	 90, 15,   0 ;SAND TOMB
	move EFFECT_OHKO,				 1, ICE,		SPECIAL,	 30,  5,   0 ;SHEER COLD
	move EFFECT_ACCURACY_DOWN_HIT,	85, WATER,		SPECIAL,	100, 15,  10 ;MUDDY WATER
	move EFFECT_MULTI_HIT,			20, GRASS,		PHYSICAL,	 90, 15,   0 ;BULLET SEED
	move EFFECT_ALWAYS_HIT,			60, FLYING,		PHYSICAL,	100, 25,   0 ;AERIAL ACE
	move EFFECT_MULTI_HIT,			25, ICE,		PHYSICAL,	 90, 15,   0 ;ICICLE SPEAR
	move EFFECT_DEFENSE_UP_2,		 0, STEEL,		STATUS,		100, 15,   0 ;IRON DEFENSE
	move EFFECT_MEAN_LOOK,			 0, NORMAL,		STATUS,		100,  5,   0 ;BLOCK
	move EFFECT_ATTACK_UP,			 0, NORMAL,		STATUS,		100, 30,   0 ;HOWL
	move EFFECT_NORMAL_HIT,			90, DRAGON,		PHYSICAL,	100, 20,   0 ;DRAGON CLAW
	move EFFECT_HYPER_BEAM,		   150, GRASS,		SPECIAL,	 90,  5,   0 ;FRENZY PLANT
	move EFFECT_BULK_UP,			 0, FIGHTING,	STATUS,		100, 15,   0 ;BULK UP
	move EFFECT_PARALYZE_HIT,		65, BUG,		PHYSICAL,	100, 20,  30 ;BOUNCE
	move EFFECT_SPEED_DOWN_HIT,		65, GROUND,		SPECIAL,	100, 15, 100 ;MUD SHOT
	move EFFECT_POISON_HIT,			75, POISON,		PHYSICAL,	100, 15,  50 ;POISON TAIL
	move EFFECT_THIEF,				50, FAIRY,		PHYSICAL,	100, 30,   0 ;COVET
	move EFFECT_RECOIL_HIT,		   130, ELECTRIC,	PHYSICAL,	100,  5,   0 ;VOLT TACKLE
	move EFFECT_ALWAYS_HIT,			65, GRASS,		SPECIAL,	100, 15,   0 ;MAGICAL LEAF
	move EFFECT_CALM_MIND,			 0, PSYCHIC_TYPE,	STATUS,	100, 15,   0 ;CALM MIND
	move EFFECT_NORMAL_HIT,			90, GRASS,		PHYSICAL,	100, 15,   0 ;LEAF BLADE
	move EFFECT_DRAGON_DANCE,		 0, DRAGON,		STATUS,		100, 10,   0 ;DRAGON DANCE
	move EFFECT_MULTI_HIT,			25, ROCK,		PHYSICAL,	 90, 15,   0 ;ROCK BLAST
	move EFFECT_ALWAYS_HIT,			65, ELECTRIC,	SPECIAL,	100, 20,   0 ;SHOCK WAVE
	move EFFECT_CONFUSE_HIT,		65, WATER,		SPECIAL,	100, 30,  10 ;WATER PULSE
	move EFFECT_FUTURE_SIGHT,	   130, STEEL,		SPECIAL,	100,  5,   0 ;DOOM DESIRE
	move EFFECT_SELF_SP_ATK_DOWN,  130, PSYCHIC_TYPE,	PHYSICAL,	100, 5,	0 ;PSYCHO BOOST
.IndirectEnd::
